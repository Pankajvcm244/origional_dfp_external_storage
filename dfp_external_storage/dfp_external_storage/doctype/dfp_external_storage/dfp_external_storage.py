...
from urllib.parse import urlparse # addition by VCM
...
class DFPExternalStorageFile(File):
    ...
    def dfp_external_storage_upload_file(self, local_file=None):
        ...
        if self.dfp_external_storage_s3_key:
            # File already on S3
            return False
        if is_url(self.file_url):  # addition by VCM
            # If file_url is a URL, we do not save it to S3
            return False  # addition by VCM
